...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField] private float randomRangeMin = -20f;
    [SerializeField] private float randomRangeMax = 20f;
    public void OrbPickedUpEventEnemySpawner()
    {
        for (int i = 0; i < amoutOfSpawnedEnemies; i++)
        {
            var randomSpawnPoint = new Vector3(Random.Range(randomRangeMin, randomRangeMax), 0.9f, Random.Range(randomRangeMin, randomRangeMax));
