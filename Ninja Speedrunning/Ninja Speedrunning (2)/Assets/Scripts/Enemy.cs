...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField] private float moveSpeedOrbIsStolen = 4f;
    [SerializeField] private float moveSpeedPlayerDetected = 5.5f;
    ...
    private void Movement()
    {
        ...
        //Movement and rotation towards location
        else
        {
    ...
    private void SearchAndDetectPlayer()
    {
        RaycastHit hit;
        int rays = 15;
        ...
        for (int i = 0; i < rays; i++)
        {
            ...
            Vector3 ray_direction = Quaternion.AngleAxis(current_angle, -lantern.transform.up) * -lantern.transform.forward;
    ...
    {
       ModifyLanternLight(fovMax, viewDistance, Color.yellow);
